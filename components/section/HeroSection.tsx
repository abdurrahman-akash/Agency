                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                            ...
                            <div className="mb-4">
                                ...
                                <h1 className="text-3xl md:text-3xl lg:text-4xl font-bold leading-tight mb-6 animate-fade-up">
                                    ...
                                    <span className="flex items-baseline">
                                        <span className="text-6xl md:text-7xl lg:text-8xl font-extrabold text-chart-1">Agency</span>
                                ...
                                <p className="text-lg text-gray-400 mb-8 max-w-xl animate-fade-up delay-200">
                                    We expedite innovative marketing, potential through years of market expertise. Our team&apos;s extensive knowledge.
                                </p>
                            </div>
                        ...
                        <div className="relative hidden lg:block animate-fade-in delay-200">
                            <div className="relative">
                                ...
                                />
                                <div className="absolute -bottom-10 -left-10 bg-zinc-100 p-6 rounded-lg shadow-xl max-w-xs animate-slide-in">
                                    <p className="text-lg font-bold mb-2">Streamline and manage your department&apos;s service delivery</p>
                                    <p className="text-sm text-gray-400">End-to-end, and enable digital transformation in a matter of days, not years.</p>
