    ...
    >
      ...
      >
        <Link href="/" className="relative z-10 group">
          ...
          >
            <span className="animate-gradient-x tracking-widest">Agency</span>
          </motion.div>
        </Link>
        ...
        <div className="hidden md:flex items-center gap-8 px-8 py-3 ">
          ...
          <MotionButton
            asChild
            className="bg-gradient-to-r from-primary to-chart-1 text-white font-semibold px-7 py-2 rounded-full shadow-lg hover:from-chart-1 hover:to-primary transition-all border-0"
          >
            <a
