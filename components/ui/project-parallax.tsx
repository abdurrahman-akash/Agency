  ...
  return (
    ...
    >
      ...
      >
        ...
        <button className="absolute bottom-10 left-1/2 -translate-x-1/2 bg-chart-1 text-white font-semibold px-6 py-3 rounded-full shadow-lg hover:bg-chart-2 transition-all">
          View All Projects
        </button>
      </motion.div>
    </div>
